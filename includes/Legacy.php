...
class Legacy {
	...
	private function __construct() {
		...
		add_action( 'wppc/transaction/after_save', [ $this, 'legacy_transaction_data' ], 10, 2 );
	}
	...
	public function get_db_version(): string {
		return get_option( 'wppc_version' );
	}
	...
	public function update_db_version( $version = '' ) {
		update_option( 'wppc_version', $version );
	}
	...
	public function upgrade_notice() {
		$message = esc_html__( 'Woo Pelecard Gateway has upgraded your database.', 'wc-pelecard-gateway' );
